  ...
  successfullyProcessed: [
    {
      ...
      downloadUrl: 'https://example.com/books/jingang-jing.pdf?openExternalBrowser=1',
    ...
    },
    {
      ...
      downloadUrl: 'https://example.com/books/xin-jing.pdf?openExternalBrowser=1',
    ...
    },
    {
      ...
      downloadUrl: 'https://example.com/books/rujmen-zhinan.pdf?openExternalBrowser=1',
      processingMethod: 'pdf_extract',
      processingSuccess: true
    }
  ],
...
const exampleUser: UserSubscription = {
  ...
  displayName: '測試用戶',
  isSubscribed: true,
  notificationTypes: ['new_books', 'news', 'cancellation'],
